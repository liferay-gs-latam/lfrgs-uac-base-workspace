...
/**
 * Copy of OpenIdConnectSessionImpl
 * Custom constructor to avoid class loading issues
 *
 * @author Edward C. Han
 */
public class CMICOpenIdConnectSessionImpl implements OpenIdConnectSession, Serializable {

	public CMICOpenIdConnectSessionImpl(OpenIdConnectSessionImpl openIdConnectSessionImpl) {
		_nonce = new Nonce(openIdConnectSessionImpl.getNonceValue());
		_openIdConnectFlowState = openIdConnectSessionImpl.getOpenIdConnectFlowState();
		_openIdProviderName = openIdConnectSessionImpl.getOpenIdProviderName();
		_state = new State(openIdConnectSessionImpl.getStateValue());
	}

	public CMICOpenIdConnectSessionImpl(String openIdProviderName, Nonce nonce, State state) {
