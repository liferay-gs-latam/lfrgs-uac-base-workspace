...
/**
 * Provides the remote service interface for CMICOrganization. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Kayleen Lim
 * @see CMICOrganizationServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface CMICOrganizationService extends BaseService {
