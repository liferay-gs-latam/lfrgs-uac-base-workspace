...
/**
 * Provides the remote service interface for CMICAnnouncementAndNotification. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Kayleen Lim
 * @see CMICAnnouncementAndNotificationServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface CMICAnnouncementAndNotificationService extends BaseService {
	...
	public List<CMICAnnouncementDisplay> getAnnouncementDisplays()
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CMICNotificationDisplay> getNotificationDisplays()
		throws PortalException;
