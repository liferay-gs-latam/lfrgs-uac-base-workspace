...
/**
 * Provides the remote service interface for CMICContact. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Kayleen Lim
 * @see CMICContactServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface CMICContactService extends BaseService {
	...
	public CMICContactDisplay fetchDirectSalesRepresentative()
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CMICContactDisplay> getTerritoryManagers()
		throws PortalException;
