...
/**
 * Provides the local service interface for CMICContact. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Kayleen Lim
 * @see CMICContactLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CMICContactLocalService extends BaseLocalService {
	...
	public CMICContactDisplay fetchDirectSalesRepresentative(long userId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CMICContactDisplay> getTerritoryManagers(long userId)
		throws PortalException;
