...
/**
 * Provides the remote service interface for CMICLossRun. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Kayleen Lim
 * @see CMICLossRunServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface CMICLossRunService extends BaseService {
	...
	public CMICPDFDocumentDisplay generateLossRunsReport(
			CMICBusinessKey cmicBusinessKey, String requestReason)
