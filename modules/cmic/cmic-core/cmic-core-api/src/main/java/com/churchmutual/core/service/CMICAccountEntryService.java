...
/**
 * Provides the remote service interface for CMICAccountEntry. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Kayleen Lim
 * @see CMICAccountEntryServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface CMICAccountEntryService extends BaseService {
