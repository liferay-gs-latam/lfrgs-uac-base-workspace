...
/**
 * Provides the local service interface for CMICQsPolicy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Kayleen Lim
 * @see CMICQsPolicyLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CMICQsPolicyLocalService extends BaseLocalService {

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CMICQsPolicyLocalServiceUtil} to access the cmic qs policy local service. Add custom service methods to <code>com.churchmutual.core.service.impl.CMICQsPolicyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CMICEligiblePolicyDisplay> getCOIEligiblePolicies(long userId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CMICEligiblePolicyDisplay> getEOPEligiblePolicies(long userId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<String> getNYWCEligiblePolicies(long userId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CMICPolicyDisplay> getPolicyDisplaysByUserId(long userId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CMICPolicyDisplay> getRecentPolicyDisplays(long userId)
		throws PortalException;
