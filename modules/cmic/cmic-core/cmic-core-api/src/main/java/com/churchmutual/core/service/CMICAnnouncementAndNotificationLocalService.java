...
/**
 * Provides the local service interface for CMICAnnouncementAndNotification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Kayleen Lim
 * @see CMICAnnouncementAndNotificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CMICAnnouncementAndNotificationLocalService
	...
	public List<CMICAnnouncementDisplay> getAnnouncementDisplays(long userId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CMICNotificationDisplay> getNotificationDisplays(long userId)
		throws PortalException;
