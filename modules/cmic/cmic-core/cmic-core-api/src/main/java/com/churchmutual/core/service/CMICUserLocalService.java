...
public interface CMICUserLocalService
	...
	public CMICUser addCMICUser(CMICUser cmicUser);
	...
	public CMICUser createCMICUser(long cmicUserId);
	...
	public CMICUser deleteCMICUser(CMICUser cmicUser);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CMICUser deleteCMICUser(long cmicUserId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CMICUser fetchCMICUser(long cmicUserId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CMICUser getCMICUser(long cmicUserId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CMICUser> getCMICUsers(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProducerType[] getProducerTypesByUserId(long userId)
		throws PortalException;
	...
	public String inviteBusinessMembers(
			long userId, CMICBusinessKey cmicBusinessKey, String emailAddresses)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CMICUser updateCMICUser(CMICUser cmicUser);
