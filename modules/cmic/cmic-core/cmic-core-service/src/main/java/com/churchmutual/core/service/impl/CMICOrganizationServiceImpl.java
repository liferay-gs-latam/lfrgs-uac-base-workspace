...
public class CMICOrganizationServiceImpl extends CMICOrganizationServiceBaseImpl {
	...
	public CMICOrganizationDisplay fetchCMICOrganizationDisplay(CMICBusinessKey cmicBusinessKey) throws PortalException {
		cmicPermissionService.checkPermission(
			cmicBusinessKey, CMICPermissionAction.VIEW.getActionId());

		return cmicOrganizationLocalService.fetchCMICOrganizationDisplay(cmicBusinessKey);
	}

	@Override
	public List<CMICOrganizationDisplay> getCMICOrganizationDisplays() throws PortalException {
		return cmicOrganizationLocalService.getCMICOrganizationDisplaysByUserId(getUserId());
	}
