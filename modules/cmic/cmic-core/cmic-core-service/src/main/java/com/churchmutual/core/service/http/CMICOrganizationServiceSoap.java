 ...
 *
 * @author Kayleen Lim
 * @see CMICOrganizationServiceHttp
 * @generated
 */
public class CMICOrganizationServiceSoap {
	...
	public static com.churchmutual.core.model.CMICOrganizationDisplay
		...
		try {
			com.churchmutual.core.model.CMICOrganizationDisplay returnValue =
				CMICOrganizationServiceUtil.fetchCMICOrganizationDisplay(
					cmicBusinessKey);
	...
	public static com.churchmutual.core.model.CMICOrganizationDisplay[]
		...
		try {
			...
			return returnValue.toArray(
				new com.churchmutual.core.model.CMICOrganizationDisplay
					[returnValue.size()]);
		}
		catch (Exception e) {
			_log.error(e, e);
