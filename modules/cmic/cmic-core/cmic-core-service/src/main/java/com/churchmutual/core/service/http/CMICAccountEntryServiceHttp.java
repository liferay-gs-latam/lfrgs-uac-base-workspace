 ...
 *
 * @author Kayleen Lim
 * @see CMICAccountEntryServiceSoap
 * @generated
 */
public class CMICAccountEntryServiceHttp {
	...
	public static String getCMICAccountEntryDisplaysCacheStatus(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCMICAccountEntryDisplaysCacheStatusParameterTypes2);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CMICAccountEntryServiceUtil.class,
				"getCMICAccountEntryDisplaysWithAddresses",
				_getCMICAccountEntryDisplaysWithAddressesParameterTypes3);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CMICAccountEntryServiceUtil.class,
				"getCMICAccountEntryDisplaysWithPermission",
				_getCMICAccountEntryDisplaysWithPermissionParameterTypes4);
	...
	public static void refreshCMICAccountEntryDisplaysCache(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CMICAccountEntryServiceUtil.class,
				"refreshCMICAccountEntryDisplaysCache",
				_refreshCMICAccountEntryDisplaysCacheParameterTypes5);
	...
	private static final Class<?>[]
		_getCMICAccountEntryDisplaysCacheStatusParameterTypes2 = new Class[] {};
	private static final Class<?>[]
		_getCMICAccountEntryDisplaysWithAddressesParameterTypes3 = new Class[] {
	...
	private static final Class<?>[]
		_refreshCMICAccountEntryDisplaysCacheParameterTypes5 = new Class[] {};
