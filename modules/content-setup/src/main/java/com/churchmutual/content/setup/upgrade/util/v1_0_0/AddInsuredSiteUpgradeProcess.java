 ...
 * @author Kayleen Lim
 */
public class AddInsuredSiteUpgradeProcess extends BaseSiteUpgradeProcess {

	public AddInsuredSiteUpgradeProcess(
			...
			GroupLocalService groupLocalService, JournalArticleLocalService journalArticleLocalService,
			LayoutSetLocalService layoutSetLocalService, PermissionCheckerFactory permissionCheckerFactory,
			Portal portal, RoleLocalService roleLocalService, StorageEngineManager storageEngineManager,
	...
	protected void doUpgradeAsAdmin() throws Exception {
		addOrUpdatePortalSite(
			portal.getDefaultCompanyId(), CMICSite.INSURED.getName(), CMICSite.INSURED.getFriendlyURL(),
